      ...
      <SC.PageContent>
        <SC.Header>
          <SC.Title>
            ...
            RUPP <SC.DeepPurple>portfolio</SC.DeepPurple>
          </SC.Title>
        </SC.Header>
        <SC.Body>
          <Icon
            ...
            animationTime={"11s"}
            src={icons.coding}
            url={"https://github.com/whatsrupp"}
          />
          <Icon
            text={"Photography"}
            animationTime={"10s"}
            src={icons.aperture}
            url={"https://www.instagram.com/nick.rupp/?hl=en"}
          />
          ...
          <Icon
            ...
            animationTime={"15s"}
            src={icons.pen}
            url={"https://medium.com/@nickrupp95"}
          />
        ...
        <SC.Footer>
          <SC.FooterText>
            The original whatsrupp website design as made at the end of Makers
            Academy June 2017
          </SC.FooterText>
        </SC.Footer>
      </SC.PageContent>
